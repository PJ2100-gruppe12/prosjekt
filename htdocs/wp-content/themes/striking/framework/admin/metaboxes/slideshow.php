...
class Theme_Metabox_Slideshow extends Theme_Metabox_With_Tabs {
	...
	public function config(){
		return array(
			'title' => sprintf(__('%s Slider Options','theme_admin'),THEME_NAME),
		...
		return array(
			array(
				...
				"options" => array(
					...
					array(
						"name" => __("Description (optional)",'theme_admin'),
						"desc" => __("<p><strong>USAGE</strong>:&nbsp;&nbsp; The Accordion Slider & Anything Slider have a 2 part caption ability.&nbsp;&nbsp; They can display the content of the caption field above in a manner similar to a title line, and also can optionally display the content of this field as paragraph text below the caption.&nbsp;&nbsp;One can display only the caption, only the description, or both together!</p><p>The font size for this text is adjustable in the Striking Font panel by way of the <b>Accordion Slider Description Text Size</b> and <b>Anything Slider Description Text Size</b> settings.</p>",'theme_admin'),	
						"id" => "_description",
						"default" => "",
						"rows" => "2",
						"type" => "textarea"
			...
			array(
				...
				"options" => array(
					...
					array(
						...
						"desc" => __("You can specify a color for the Anything Slider Caption background which will override the default black color. Set to transparent to disable the caption background color.",'theme_admin'),
						"id" => "_anything_caption_bg",
						"default" => "",
						"type" => "color"
					),
					array(
						"name" => __("Sidebar Background Color",'theme_admin'),
						"desc" => __("You can specify a color for the Anything Slider Sidebar background which will override the default black color. Set to transparent to disable the sidebar color.",'theme_admin'),
						"id" => "_anything_bg",
						"default" => "",
						"type" => "color"
					),
					array(
						"name" => __("Image Caption Position",'theme_admin'),
					...
					array(
						"name" => __("Sidebar Position",'theme_admin'),
			...
			array(
				"name" => __("3D image Rotator",'theme_admin'),
				"options" => array(
					array(
						"name" => __("Transition Pieces",'theme_admin'),
						"desc" => __("Number of pieces to which the image is sliced. If set to 0, it will use the general setting.",'theme_admin'),
						"id" => "_3d_pieces",
						"min" => "0",
						"max" => "30",
						"step" => "1",
					...
					array(
						"name" => __("Transition Time",'theme_admin'),
						"desc" => __("Number of seconds for each element to be turned. If set to 0, it will use the general setting.",'theme_admin'),
						"id" => "_3d_time",
						"min" => "0",
						"max" => "3",
						"step" => "0.1",
					...
					array(
						"name" => __("Transition Delay",'theme_admin'),
						"desc" => __("Number of seconds from one element starting to turn to the next element starting. If set to 0, it will use the general setting.",'theme_admin'),
						"id" => "_3d_delay",
						"min" => "0",
						"max" => "1",
						"step" => "0.1",
					...
					array(
						"name" => __("Transition Depth Offset",'theme_admin'),
						"desc" => __("The offset during transition on the z-axis. If set to 0, it will use the general setting.",'theme_admin'),
						"id" => "_3d_depthOffset",
						"min" => "0",
						"max" => "1000",
						"step" => "100",
					...
					array(
						"name" => __("Transition Cube Distance",'theme_admin'),
						"desc" => __("The distance between the cubes during transition. If set to 0, it will use the general setting.",'theme_admin'),
						"id" => "_3d_cubeDistance",
						"min" => "0",
						"max" => "50",
						"step" => "5",
