...
class Theme_Options_Page_Sidebar extends Theme_Options_Page_With_Tabs {
	...
	function __construct(){
		$this->name = sprintf(__('%s Sidebar Settings','theme_admin'),THEME_NAME);
		parent::__construct();
	}
	...
	function tabs(){
		$options = array(
			...
			array(
				"name" => __("Archive Type Pages Custom Sidebar - Global Settings",'theme_admin'),
				"slug" => "archive",
				"options" => array(
					array(
