...
class Theme_Options_Page_Slideshow extends Theme_Options_Page_With_Tabs {
	...
	function __construct(){
		$this->name = sprintf(__('%s SlideShow Settings','theme_admin'),THEME_NAME);
		parent::__construct();
	}
	function tabs(){
		$options = array(
			array(
				"slug" => 'general',
				"name" => __("Post & Portfolio Linking Settings",'theme_admin'),
				"options" => array(
					array(
						"name" => __("Blog Posts linkable",'theme_admin'),
						"desc" => __("If toggled to <em>ON</em>, then if you select Blog Post Category in the slideshow source, the featured image of each blog post item in that category will be shown in the slideshow, and clicking on the slide image will link directly to that blog single post.",'theme_admin'),
						"id" => "post_linkable",
						"default" => true,
						"type" => "toggle"
					),
					array(
						"name" => __("Portfolio Posts linkable",'theme_admin'),
						"desc" => __("If toggled to <em>ON</em>, then if you select Portfolio Post Category in the slideshow source, the featured image of each portfolio post item in that category will be shown in the slideshow, and  clicking on that slide image will link directly to that portfolio single post.",'theme_admin'),	
			...
			array(
				...
				"options" => array(
					...
					array(
						...
						"desc" => __("Select which transition effect to use for the slideshow.",'theme_admin'),
						"id" => "nivo_effect",
						"default" => 'random',
						"options" => array(
							"random" => 'random',
					...
					array(
						...
						"desc" => __("Define the delay for transitions from slide to slide.",'theme_admin'),
						"id" => "nivo_pauseTime",
						"min" => "1000",
						"max" => "30000",
						"step" => "500",
					...
					array(
						"name" => __("Enable Keyboard Navigation",'theme_admin'),
						"desc" => __("If you want to enable keyboard navigation where your site visitor can use left & right arrows to transition the slideshow, toggle this setting to <em>ON</em>.",'theme_admin'),
						"id" => "nivo_keyboardNav",
						"default" => true,
						"type" => "toggle"
					),
					array(
						"name" => __("Enable Pause On Hover",'theme_admin'),
						"desc" => __("If you want stop the nivo slider transtions from slide to slide when a user hovers their cursor over the slider, toggle this setting to <em>ON</em>.",'theme_admin'),
						"id" => "nivo_pauseOnHover",
						"default" => true,
						"type" => "toggle"
					),
					array(
						"name" => __("Enable Manual Transitions",'theme_admin'),
						"desc" => __("If you want the slideshow to advance from slide to slide oly when the viewer clicks on the left and right navigation arrows, or navigation buttons (if enabled) toggle this setting to <em>ON</em>.&nbsp;&nbsp;Note that when you have this setting active, the <b>Pause on Hover</b> setting above is not applicable",'theme_admin'),
			...
			array(
				...
				"options" => array(
					...
					array(
						"name" => __("Height and Width",'theme_admin'),
						"desc" => __("The Image Rotator slider has 5 height settings to choose from - 150, 250, 320, 400 and 440px.&nbsp;&nbsp;The width of the Image Rotator slider is 960px.&nbsp;&nbsp;So all pictures used in this slider should have a dimension of 960px x H.",'theme_admin'),
						"id" => "3d_height",
						"default" => '440',
						"options" => array(
							"150" => '150px',
					...
					array(
						"name" => __("Segments",'theme_admin'),
						"desc" => __("Number of segments in which the image will be sliced.",'theme_admin'),
						"id" => "3d_segments",
						"min" => "1",
						"max" => "30",
						"step" => "1",
					...
					array(
						"name" => __("Tween Time",'theme_admin'),
						"desc" => __("Number of seconds for each element to be turned.",'theme_admin'),
						"id" => "3d_tweenTime",
						"min" => "0",
						"max" => "3",
						"step" => "0.1",
					...
					array(
						"name" => __("Tween Delay",'theme_admin'),
						"desc" => __("Number of seconds from one element starting to turn to the next element starting.",'theme_admin'),
						"id" => "3d_tweenDelay",
						"min" => "0",
						"max" => "1",
						"step" => "0.1",
					...
					array(
						"name" => __("Tween Type",'theme_admin'),
						"desc" => __("Select which effect to use when transition.",'theme_admin'),
						"id" => "3d_tweenType",
					...
					array(
						"name" => __("Z Distance",'theme_admin'),
						"desc" => __("To which extend are the cubes moved on z axis when being tweened.&nbsp;&nbsp;Negative values bring the cube closer to the camera, positive values take it further away.",'theme_admin'),
						"id" => "3d_zDistance",
						"min" => "-200",
						"max" => "700",
						"step" => "50",
					...
					array(
						"name" => __("Expand",'theme_admin'),
						"desc" => __("To which extend are the cubes moved away from each other when tweening.",'theme_admin'),
						"id" => "3d_expand",
						"min" => "0",
						"max" => "100",
						"step" => "5",
					...
					array(
						"name" => __("Inner Color",'theme_admin'),
						"desc" => __("Color of the sides of the elements in hex values",'theme_admin'),
						"id" => "3d_innerColor",
						"default" => "#111111",
						"type" => "color"
					),
					array(
						"name" => __("Shadow Darkness",'theme_admin'),
						"desc" => __("To which extend are the sides shadowed, when the elements are tweening and the sided move towards the background.&nbsp;&nbsp;100 is black, 0 is no darkening.",'theme_admin'),
					...
					array(
						...
						"desc" => __("Number of seconds to the next image, when autoplay is on.&nbsp;&nbsp;Set 0, if you don‘t want autoplay.",'theme_admin'),
						"id" => "3d_autoplay",
						"min" => "0",
						"max" => "20",
						"step" => "1",
			...
			array(
				...
				"options" => array(
					...
					array(
						"name" => __("AutoPlay",'theme_admin'),
						"desc" => __("If you want slider expand automatically, turn on the button.&nbsp;&nbsp;If you leave this setting off, then the viewer will have to click on each slide in order to see it fully.",'theme_admin'),
						"id" => "kwicks_autoplay",
						"default" => true,
						"type" => "toggle"
					),
					array(
						"name" => __("AutoPlay Pause Time",'theme_admin'),
						"desc" => __("Set the transition time by which each slide will have to wait to be played",'theme_admin'),
						"id" => "kwicks_pauseTime",
						"min" => "1000",
						"max" => "10000",
						"step" => "500",
					...
					array(
						"name" => __("Number Of Slides",'theme_admin'),
						"desc" => __("Set the number of slides to show.",'theme_admin'),
						"id" => "kwicks_number",
						"min" => "2",
						"max" => "8",
						"step" => "1",
					...
					array(
						...
						"desc" => __("Define the width of a fully expanded slider element.&nbsp;&nbsp;The miminum width is 240 px and the max width is 960px, in 10 px increments.",'theme_admin'),
						"id" => "kwicks_max",
						"min" => "240",
						"max" => "960",
						"step" => "10",
					...
					array(
						"name" => __("Animation Speed",'theme_admin'),
						"desc" => __("Set the duration of the animations.",'theme_admin'),
						"id" => "kwicks_duration",
						"min" => "0",
						"max" => "3000",
						"step" => "100",
					...
					array(
						"name" => __("Caption Opacity",'theme_admin'),
						"desc" => __("Define the Opacity of caption.",'theme_admin'),
					...
					array(
						"name" => __("Description Opacity",'theme_admin'),
						"desc" => __("Define the Opacity of detail.",'theme_admin'),
			...
			array(
				"slug" => 'anything',
				"name" => __("Anything Slider Settings when in Featured Header Area",'theme_admin'),
				"options" => array(
					array(
						"name" => __("General Info, Height and Width",'theme_admin'),
					...
					array(
						"name" => __("Show Navigation Arrows",'theme_admin'),
						"desc" => __("If <em>ON</em>, displays the forwards and backwards navigation arrows",'theme_admin'),
						"id" => "anything_buildArrows",
						"default" => true,
						"type" => "toggle"
					),
					array(
						"name" => __("Hover only for Navigation Arrows",'theme_admin'),
						"desc" => __("If <em>ON</em>, the side navigation arrows will slide out on hovering & hide when a user cursor moves off the slider item.",'theme_admin'),
					...
					array(
						"name" => __("Enable Navigation Display on Changeup/Hover only",'theme_admin'),
						"desc" => __("If <em>ON</em>, the various navigation controls (navigation + play/stop button) appear on hover and slide change, and hide at otherwise.",'theme_admin'),
						"id" => "anything_toggleControls",
						"default" => false,
						"type" => "toggle"
					),
					array(
						"name" => __("Enable Arrows for Navigation",'theme_admin'),
						"desc" => __("When <em>OFF</em>, the navigation arrows will be visible, but not clickable.&nbsp;&nbsp;Typically one has the setting <em>ON</em> so that the navigations arrows, if set to show by the above settings, actually function.",'theme_admin'),
						"id" => "anything_enableArrows",
						"default" => true,
						"type" => "toggle"
					),
					array(
						"name" => __("Enable Buttons for Navigation",'theme_admin'),
						"desc" => __("When <em>OFF,</em> the navigation buttons will be visible, but not clickable.",'theme_admin'),
					...
					array(
						"name" => __("Enable Keyboard Navigation",'theme_admin'),
						"desc" => __("If <em>ON</em>, keyboard arrow keys will work for navigation for this slider.",'theme_admin'),
					...
					array(
						...
						"desc" => __("If <em>ON</em>, starting a slideshow will delay advancing slides; if false, the slider will immediately advance to the next slide when the page loads.",'theme_admin'),
					...
					array(
						...
						"desc" => __("If <em>ON</em> & the slideshow is active & a youtube video is playing, the autoplay will pause until the video completes",'theme_admin'),
						"id" => "anything_resumeOnVideoEnd",
						"default" => true,
						"type" => "toggle"
					),
					array(
						"name" => __("resumeOnVisible",'theme_admin'),
						"desc" => __("If true the video will resume playing (if previously paused, except for YouTube iframe - known issue); if false, the video remains paused.",'theme_admin'),
					...
					array(
						"name" => __("Blog & Portfolio Posts Caption Position",'theme_admin'),
