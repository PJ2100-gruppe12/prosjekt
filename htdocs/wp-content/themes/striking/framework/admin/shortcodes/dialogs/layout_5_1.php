...
$custom_script = <<<HTML
	...
	return '\\n[five_sixth]'+attrs['column_1'].value+'[/five_sixth]\\n[one_sixth_last]'+attrs['column_2'].value+'[/one_sixth_last]\\n';
HTML;
return array(
	"title" => __("Five Sixth - One Sixth Columns Layout", "striking_admin"),
