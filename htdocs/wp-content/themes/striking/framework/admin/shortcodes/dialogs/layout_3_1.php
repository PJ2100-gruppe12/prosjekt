...
$custom_script = <<<HTML
	...
	return '\\n[three_fourth]'+attrs['column_1'].value+'[/three_fourth]\\n[one_fourth_last]'+attrs['column_2'].value+'[/one_fourth_last]\\n';
HTML;
return array(
	"title" => __("Three Fourth - One Fourth Columns Layout", "striking_admin"),
