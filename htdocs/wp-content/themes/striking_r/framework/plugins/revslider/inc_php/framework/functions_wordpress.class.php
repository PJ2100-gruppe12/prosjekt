<?php
	...
	class UniteFunctionsWPRev{
		...
		public static function import_media($file_url, $folder_name) {
			...
			Array
			(
				[path] => /Users/dirk/Dropbox/htdocs/revslider/wp-content/uploads/2013/12
				[url] => http://server.local/revslider/wp-content/uploads/2013/12
				[subdir] => /2013/12
				[basedir] => /Users/dirk/Dropbox/htdocs/revslider/wp-content/uploads
				[baseurl] => http://server.local/revslider/wp-content/uploads
				[error] => 
			)
			echo '<pre>';
			...
			echo '</pre>';
			*/
			//$upload_dir = self::getPathUploads();
			//if(strpos($upload_dir, 'uploads/') === false) $artDir = 'uploads/'.$artDir;
			...
			//echo $upload_dir.'||||';
			//echo $ul_dir['baseurl'].'/'.$artDir.$folder_name.$filename;
			//exit;
