...
?>
	...
	<div>		
		...
		<ul>
			<li>
				<?php _e("* From the",REVSLIDER_TEXTDOMAIN)?> <b><?php _e("theme html",REVSLIDER_TEXTDOMAIN)?></b> <?php _e("use",REVSLIDER_TEXTDOMAIN)?>: <code>&lt?php putRevSlider( "alias" ) ?&gt</code> <?php _e("example",REVSLIDER_TEXTDOMAIN)?>: <code>&lt?php putRevSlider(<?php echo $exampleID?>) ?&gt</code>
				<br>
				&nbsp;&nbsp; <?php _e("For show only on homepage use",REVSLIDER_TEXTDOMAIN)?>: <code>&lt?php putRevSlider(<?php echo $exampleID?>,"homepage") ?&gt</code>
				<br>&nbsp;&nbsp; <?php _e("For show on certain pages use",REVSLIDER_TEXTDOMAIN)?>: <code>&lt?php putRevSlider(<?php echo $exampleID?>,"2,10") ?&gt</code> 
			</li>
