...
function theme_shortcode_image($atts, $content = null, $code) {
	...
	if ( is_feed() ) {
		...
		return '<figure class="image_styled'.($align?' align'.$align:'').'" style="width:'.($width+2).'px;">
		<div class="image_frame effect-'.$effect.'" style="'.((empty($height))?'':'height:'.($height+2).'px').'"><div class="image_shadow_wrap">
