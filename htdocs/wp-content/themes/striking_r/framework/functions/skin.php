...
CSS;
	$css .= theme_color_fallback('color',$color['read_more_active_bg']);
	$css .= <<<CSS
}
...
ul.mini_tabs li a.current, ul.mini_tabs a:hover {
CSS;
	$css .= theme_color_fallback('background-color',$color['page_bg']);
	$css .= <<<CSS
}
...
#page ul.vertical_tabs li a {
CSS;
	$css .= theme_color_fallback('color',$color['verticaltab_text']);
	$css .= <<<CSS
}
ul.vertical_tabs li a.current, ul.vertical_tabs a:hover  {
CSS;
	$css .= theme_color_fallback('background-color',$color['page_bg']);
	$css .= <<<CSS
}
...
.accordion .tab.current, .accordion .tab.current a {
CSS;
