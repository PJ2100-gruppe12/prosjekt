...
if($title === true || $meta === true):?>
	<div class="entry_info">
		<?php if($title === true):?><h2 class="entry_title"><a href="<?php echo get_permalink() ?>" rel="bookmark" title="<?php printf( __("Permanent Link to %s", 'theme_front'), get_the_title() ); ?>"><?php the_title(); ?></a></h2><?php endif;?>
