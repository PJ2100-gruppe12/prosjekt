...
= 1.9.4 =
* Added:  Tweaked Turkish Translation
...
= 1.9.1 =
* Fix: Fixed description field layout.
...
= 0.7.5 =
* Only display scripts when coming soon page is rendered.
* Fixed Double Confirm Bug
* Added theme my login support
...
= 0.7 =
* Notification of Pro Version Release
* Greek and Slovenian Translations Added
